...
export default function NavigationCard(){
	...
	const activeElementClasses = 'text-sm md:text-md flex md:gap-1 md:gap-3 py-3 my-1 bg-socialBlue text-white md:-mx-8 px-6 md:px-8 rounded-md shadow-md shadow-gray-300';
	const nonActiveElementClasses = 'text-sm md:text-md flex md:gap-1 md:gap-3 py-2 my-2 hover:bg-blue-200 hover:bg-opacity-50 md:-mx-4 md:px-6 md:px-4 rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300';
	...
	return (
			<Card className='sm:items-center' noPadding={true}>
				<div className='px-4 py-2 flex gap-4 justify-between md:block shadow-md shadow-gray-500 md:shadow-none'>
					...
					<button onClick={logout} className='-my-2 w-full'>
						<span className={pathname === '/login' ? activeElementClasses : nonActiveElementClasses}>
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
