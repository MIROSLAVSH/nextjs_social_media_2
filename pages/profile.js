									...
									<div className='text-right'>
										{isMyUser && !editMode && (
											<button 
												...
												className='inline-flex bg-white rounded-md shadow-sm px-2 py-1 shadow-gray-500 gap-1'
											>
										...
										{isMyUser && editMode && (
											<button onClick={saveProfile} className='inline-flex mx-1 bg-white rounded-md shadow-sm px-2 py-1 shadow-gray-500 gap-1'>
												Save profile
											</button>
										)}
										{isMyUser && editMode && (
											<button onClick={() => setEditMode(false)} className='inline-flex bg-white rounded-md shadow-sm px-2 py-1 shadow-gray-500 gap-1'>
												Cancel
											</button>
										)}
									</div>
