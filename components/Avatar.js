...
export default function Avatar({size, url, editable, onChange}) {
	...
	return (
		<div className={`relative`}>
			<div className={`${width} ${height} rounded-full overflow-hidden object-cover`}>
			...
			{editable && (
				<label className='bg-white absolute p-2 bottom-0 rounded-full right-0 shadow-lg shadow-gray-500 cursor-pointer'>
