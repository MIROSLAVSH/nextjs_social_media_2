			...
			<div className="flex gap-3">
				...
				<div className='relative'>
					...
					{/* <ClickOutHandler onClickOut={handleClickOutsideDropdown}> */}
						<div className='relative'>
							{/* {dropdownOpen && ( */}
								<div className='absolute -right-6 -top-8 bg-white shadow-md shadow-gray-300 rounded-sm border-gray-100 p-3 w-52'>
				...
				{photos?.length > 0 && (
					<div className="flex gap-4">
						{photos.map(photo => (
							...
							<div key={photo} className='overflow-hidden object-cover'>
				...
				<div className='border grow rounded-full'>
						<form onSubmit={postComment}>
							<input
								...
								className='resize-none block w-full p-3 px-4 overflow-hidden h-12 rounded-full' placeholder='Leave a comment' 
							/>
						</form>
					{/* <div className='relative'>
						<button className='absolute top-[-35px] right-3 text-gray-400'>
